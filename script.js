...
const apiKey = '91d482c52002ad5c856720f503a81d04'
...
forecastsData.list.forEach(forecastWeather => {
    if(forecastWeather.dt_txt.includes(timeTaken)) !forecastWeather.dt_txt.includes(todayDate)
        ...
        const forecastDate = forecastWeather.dt_txt.split(' ')[0];  // Extract forecast date
        const forecastTime = forecastWeather.dt_txt.split(' ')[1]; 
        if (forecastTime === timeTaken && forecastDate !== todayDate) {
            updateForecastItems(forecastWeather);  // Update forecast display for valid forecasts
        }
